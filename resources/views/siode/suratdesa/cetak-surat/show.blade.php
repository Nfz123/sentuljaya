...
<body>
    <div style="margin:1cm">
        <div style="height:100px;width:100%" class="mb-5">
            ...
            <div class="lh-20px text-center">
                <span style="font-size: 16pt" class="font-weight-bold">PEMERINTAHAN KABUPATEN
                    {{ Str::upper($desa->nama_kabupaten) }}</span><br>
                <span style="font-size: 16pt" class="font-weight-bold">KECAMATAN
                    {{ Str::upper($desa->nama_kecamatan) }}</span><br>
                <span style="font-size: 16pt" class="font-weight-bold">{{ Str::upper($desa->kategori_surat) }} DESA
        ...
        @if ($surat->perihal == 1)
            ...
            <div style="margin-left: 50%; width: 50%" class="float-right text-center">
                <p style="margin-bottom: 55px">{{ $desa->nama_desa }}, {{ $tanggal }}<br>Kepada
                    {{ $perihal[3] }}</p>
                <p>Di - {{ $perihal[4] }}</p>
            </div>
        @else
